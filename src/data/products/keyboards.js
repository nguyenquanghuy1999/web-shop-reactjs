export const keyboards = [
    {
        ...
        details: {
            ...
            descs: [
                {
                    title: 'Switch độc quyền từ DareU',
                    img: require('../../assets/images/desc-product/kb2.png'),
                    content: 'Được sử dụng switch "D" do chính DareU sản xuất, chất lượng của loại switch này đã được kiểm chứng trên các mẫu phím nổi tiếng của DareU trước đây. Chất lượng gõ cực kỳ trơn tru và bền bỉ không thua kém các loại switch cao cấp khác.'
                },
                {
                    title: 'Đa dạng về switch',
                    img: require('../../assets/images/desc-product/kb3.png'),
                    content: 'Ngoài ra DareU EK880 được trang bị đầy đủ 3 loại switch cơ bản là Blue - Brown - Red cho người sử dụng có thể chọn được loại bàn phím phù hợp với nhu cầu của mình. Đây cũng là lợi thế cạnh tranh mạnh mà DareU EK880 mang đến cho các đối thủ.',
                },
            ]
        }
    },
